...
from .routers import auth_router, users_router, games_router, payments_router, notifications_router, preferences_router, locations_router, discussion_router, razorpay_router
...
if STATIC_DIR and Path(STATIC_DIR).is_dir():
    ...
    async def serve_spa(full_path: str):
        ...
        if full_path and not full_path.startswith("api"):
            ...
            if file_path.is_relative_to(_static.resolve()) and file_path.is_file():
